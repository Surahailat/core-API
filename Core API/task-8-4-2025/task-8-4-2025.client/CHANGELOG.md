...
- Create Angular project with ng: `ng new task-8-4-2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task-8-4-2025.client.esproj`).
